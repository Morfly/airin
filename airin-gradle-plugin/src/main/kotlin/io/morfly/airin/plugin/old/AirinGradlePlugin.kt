...
//            val isAllowed = properties.inputProjects.isEmpty()
//                    || target.path in allowedProjects
//                    || target.path == root.path
//            val isSkipped = target.path in properties.skippedProjects
//
...
//            }
//
//            if (!project.skipped && packageComponent != null) {
//                outputFiles += project
...
//        queue += properties.inputProjects.map(root::project)
//
...
//    ): Boolean {
//        if (configuration in properties.skippedConfigurations) return false
//
//        return with(properties.configurations) {
//            isEmpty()
