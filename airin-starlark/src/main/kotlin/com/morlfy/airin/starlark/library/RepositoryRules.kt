 ...
 *
 */
fun BaseConfigurationContext.http_archive(
    name: Name,
 ...
 *
 */
fun BaseConfigurationContext.http_archive(body: HttpArchiveContext.() -> Unit) =
 ...
 *
 */
fun BaseConfigurationContext.http_file(
    name: Name,
    auth_patterns: Map<Key, Value>? = UnspecifiedDictionary,
    canonical_id: StringType? = UnspecifiedString,
 ...
 *
 */
fun BaseConfigurationContext.http_file(body: HttpFileContext.() -> Unit) =
...
fun BaseConfigurationContext.http_jar(
    name: Name,
    auth_patterns: Map<Key, Value>? = UnspecifiedDictionary,
    canonical_id: StringType? = UnspecifiedString,
    netrc: StringType? = UnspecifiedString,
 ...
 *
 */
fun BaseConfigurationContext.http_jar(body: HttpJarContext.() -> Unit) =
 ...
 *
 */
fun BaseConfigurationContext.git_repository() {
    TODO()
}
 ...
 *
 */
fun BaseConfigurationContext.git_repository(body: GitRepositoryContext.() -> Unit) =
 ...
 *
 */
fun BaseConfigurationContext.new_git_repository() {
    TODO()
}
 ...
 *
 */
fun BaseConfigurationContext.new_git_repository(body: NewGitRepositoryContext.() -> Unit) =
